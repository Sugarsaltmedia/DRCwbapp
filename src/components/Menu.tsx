      ...
      <div className="sticky top-0 z-40 bg-neutral-950/80 backdrop-blur-xl border-b border-neutral-800/50">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={openCart}
              className="relative btn-primary flex items-center gap-2 px-3 sm:px-4 py-2.5 text-sm sm:text-base"
            >
              ...
              {state.items.length > 0 && (
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="absolute -top-2 -right-2 w-6 h-6 bg-accent-500 rounded-full flex items-center justify-center text-xs font-bold text-white border-2 border-neutral-950"
                >
        ...
        {!selectedCategory ? (
          ...
          <div className="space-y-8">
            <div className="text-center space-y-4">
              <h2 className="text-3xl font-bold gradient-text">Choose Your Category</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4 py-8">
              <div className="w-20 h-20 bg-gradient-to-br from-neutral-800 to-neutral-700 rounded-3xl flex items-center justify-center mx-auto border border-neutral-700">
              ...
              <h2 className="text-3xl font-bold gradient-text">{selectedCategoryData?.name}</h2>
            ...
            <div className="space-y-4">
              ...
              {filteredItems.length === 0 && (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-2xl font-bold text-neutral-300 mb-2">No items found</h3>
                  <p className="text-neutral-500">Try adjusting your search or browse other categories</p>
                </div>
              )}
            </div>
          </div>
