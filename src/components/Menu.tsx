      ...
      <div className="sticky top-0 z-40 bg-neutral-950/80 backdrop-blur-xl border-b border-neutral-800/50">
        <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={openCart}
              className="relative btn-primary flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base"
            >
          ...
          <div className="relative">
            <Search className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-neutral-500" size={18} />
            <input
              type="text"
              placeholder="Search for food..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="input-field w-full pl-10 sm:pl-12 pr-4 text-sm sm:text-base"
            />
          </div>
        </div>
      </div>
        ...
        {!selectedCategory ? (
          ...
          <div className="space-y-8">
            <div className="text-center space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-bold gradient-text">Choose Your Category</h2>
              <p className="text-neutral-400 text-sm sm:text-lg max-w-2xl mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="text-center space-y-3 sm:space-y-4 py-6 sm:py-8">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-neutral-800 to-neutral-700 rounded-3xl flex items-center justify-center mx-auto border border-neutral-700">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold gradient-text">{selectedCategoryData?.name}</h2>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              {filteredItems.length === 0 && (
                <div className="text-center py-12 sm:py-16">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-neutral-300 mb-2">No items found</h3>
                  <p className="text-neutral-500 text-sm sm:text-base px-4">Try adjusting your search or browse other categories</p>
                </div>
              )}
            </div>
          </div>
