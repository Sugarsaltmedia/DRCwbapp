    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex">
        ...
        <motion.div
          ...
          className="ml-auto w-full max-w-md bg-neutral-950/95 backdrop-blur-xl border-l border-neutral-800 flex flex-col h-full max-h-screen"
        >
          {/* Header */}
          <div className="p-4 sm:p-6 border-b border-neutral-800 flex-shrink-0">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-primary-500/20 rounded-xl flex items-center justify-center">
              ...
              <button
                onClick={closeCart}
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-neutral-800 hover:bg-neutral-700 flex items-center justify-center text-neutral-400 hover:text-white transition-all duration-300 border border-neutral-700"
              >
          ...
          {/* Footer */}
          {state.items.length > 0 && (
            <div className="p-4 sm:p-6 border-t border-neutral-800 bg-neutral-950/80 backdrop-blur-sm flex-shrink-0">
              {/* Order Summary */}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full btn-primary py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-xl sm:rounded-2xl"
              >
                Proceed to Checkout
              </motion.button>
